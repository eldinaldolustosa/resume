...
Consulte também o arquivo ../../prompt/prompt_pt-br.md para um prompt detalhado e orientações específicas.
...
Estas dicas foram adaptadas do artigo da Harvard. Recomendo a leitura completa do artigo.
